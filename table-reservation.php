                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="reservation_date">Күн</label>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="reservation_time">Уақыт</label>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="number_of_guests">Қанша адам?</label>
                            <select class="form-control" name="number_of_guests">
                                <option value="1" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>
                                Бір кісі
                                </option>
                                <option value="2" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>Еки кісі</option>
                                <option value="3" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>Уш кісі</option>
                                <option value="4" <?php echo (isset($_POST['number_of_guests']))?"selected":"";  ?>>Торт кісі</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <div class="form-group">
                            <label for="check_availability" style="visibility: hidden;">Қол жетімділікті тексеру</label>
            ...
            <?php
                ...
                if(isset($_POST['check_availability_submit']))
                {
                    ...
                    if($stmt->rowCount() == 0)
                    {
                        ?>
                            <div class="error_div">
                                <span class="error_message" style="font-size: 16px">БАРЛЫҚ ҮСТЕЛДЕР БЕРІЛГЕН</span>
                            </div>
                        <?php
                    }
                    else
                    {
                        ...
                        ?>
                            ...
                            <form method="POST" action="table-reservation.php">
                                ...
                                <div class="form-group">
                                    <input type="submit" name="submit_table_reservation_form" class="btn btn-info" value="Брондау">
                                </div>
                            </form>
                        <?php
                    }
