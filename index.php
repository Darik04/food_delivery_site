...
?>
			...
			<div class="row" style="flex-wrap: nowrap;">
				<div class="col-md-6 home-left-section">
					<div style="padding: 100px 0px; color: white;">
						...
						<h2>
						БІЗ АДАМДАРДЫ БАҚЫТТЫ ЕТЕМІЗ
						</h2>
						<hr>
						<p>
						Шие қызанақ пен жасыл гүл қосылған итальяндық пицца
						</p>
	...
	<section class="our_menus" id="menus">
		<div class="container">
			<h2 style="text-align: center;margin-bottom: 30px">БІЗДІҢ МӘЗІР</h2>
            ...
            <div class="row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        <h2>
						Бізбен хабарласыңы &
                             <br>бізге бүгін хабарлама жіберіңіз!
                        </h2>
                        <p>
                    ...
                    <div class="contact-form">
                        <div id="contact_ajax_form" class="contactForm">
                            <div class="form-group colum-row row">
                                <div class="col-sm-6">
                                    <input type="text" id="contact_name" name="name" oninput="document.getElementById('invalid-name').innerHTML = ''"  class="form-control" placeholder="Атыныз">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <input type="text" id="contact_subject" name="subject" oninput="document.getElementById('invalid-subject').innerHTML = ''"  class="form-control" placeholder="Тақырып">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <textarea id="contact_message" name="message" oninput="document.getElementById('invalid-message').innerHTML = ''" cols="30" rows="5" class="form-control message" placeholder="Хабар"></textarea>
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <button id="contact_send" class="bttn_style_2">Хат жіберу</button>
                                </div>
                            </div>
