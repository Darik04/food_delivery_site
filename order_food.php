	...
	<section class="order_food_section">
		...
		<form method="post" id="order_food_form" action="order_food.php">
			...
			<div class="select_menus_tab order_food_tab" id="menus_tab">
                ...
                Кем дегенде бір элементті таңдаңыз!
				</div>

                <div class="text_header">
                    <span>
                        1. Элементтерді таңдау
                    </span>
                </div>
            ...
            <div class="client_details_tab order_food_tab" id="clients_tab">
                ...
                <div>
                    <div class="form-group colum-row row">
                        <div class="col-sm-12">
                            <input type="text" name="client_full_name" id="client_full_name" oninput="document.getElementById('required_fname').style.display = 'none'"  class="form-control" placeholder="Толык аты">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text"  name="client_phone_number" id="client_phone_number" oninput="document.getElementById('required_phone').style.display = 'none'" class="form-control" onkeyup="this.value=this.value.replace(/[^0-9]/g,'');" placeholder="Телефон номер">
                    ...
                    <div class="form-group colum-row row">
                        <div class="col-sm-12">
                            <input type="text" name="client_delivery_address" id="client_delivery_address" oninput="document.getElementById('required_delivery_address').style.display = 'none'" class="form-control" placeholder="Жеткизу Адрес">
            ...
            <div style="overflow:auto;padding: 30px;">
                <div style="float:right;">
                    ...
                    <button type="button" class="next_prev_buttons" style="background-color: #bbbbbb;"  id="prevBtn"  onclick="nextPrev(-1)">Алдыңғы</button>
                    <button type="button" id="nextBtn" class="next_prev_buttons" onclick="nextPrev(1)">Келесі</button>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <p>
                        Біздің мейрамхана ең жақсылардың бірі болып табылады, дәмді мәзірлер мен тағамдар ұсынады.
                        </p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        ...
                        <li>Дүйсенбі - Жұма 08:00 - 22:00</li>
                            <li>Сенбі - Жексенбі 09:30 - 20:00</li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="footer_widget">
                        <h3>Біздің мазмұнымызға жазылыңыз</h3>
                        <div class="subscribe_form">
                            <form action="#" class="subscribe_form" novalidate="true">
                                <input type="email" name="EMAIL" id="subs-email" class="form_input" placeholder="Email...">
                                <button type="submit" class="submit">ЖАЗЫЛУ</button>
