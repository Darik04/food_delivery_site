<?php
	...
	$pageTitle = 'Веб-сайт параметрлері';
                   		...
                   		<div class="panel-X">
                            ...
                            <div class="save-header-X">
                                <div style="display:flex">
                                    ...
                                    <div class="title-container">Website акпараты</div>
                                </div>
                                <div class="button-controls">
                                    <button type="submit" name="save_settings" class="btn btn-primary">Сактау</button>
                                </div>
                            </div>
