            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Жана Санат Косу</h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <label for="category_name">Санат атауы</label>
                                        <input type="text" id="category_name_input" class="form-control"  placeholder="Атауы" name="category_name">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Бастарту</button>
                                    <button type="button" class="btn btn-info" id="add_category_bttn">Санат Косу</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table table-bordered categories-table">
                        <thead>
                            <tr>
                                <th scope="col">Санат ID</th>
                                <th scope="col">Санат Атауы</th>
