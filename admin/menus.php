                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered menus-table">
                            <thead>
                                <tr>
                                    <th scope="col">Мәзір атауы</th>
                                    <th scope="col">Мәзір санаты</th>
                                    <th scope="col">Толыгырак</th>
                                    <th scope="col">Багасы</th>
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title">Мәзірді жою</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>
                                                                            <div class="modal-body">
                                                                            Осы мәзірді жойғыңыз келетініне сенімдісіз бе "<?php echo strtoupper($menu['menu_name']); ?>"?
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                                                                <button type="button" data-id = "<?php echo $menu['menu_id']; ?>" class="btn btn-danger delete_menu_bttn">Жою</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="panel-X">
                                    ...
                                    <div class="panel-body-X">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  value="<?php echo (isset($_POST['menu_name']))?htmlspecialchars($_POST['menu_name']):'' ?>" placeholder="Menu Name" name="menu_name">
                                            <?php
                                ...
                                <form method="POST" class="menu_form" action="menus.php?do=Edit&menu_id=<?php echo $menu['menu_id'] ?>" enctype="multipart/form-data">
                                    <div class="panel-X">
                                        ...
                                        <div class="panel-body-X">
                                            ...
                                            <div class="form-group">
                                                <label for="menu_name">Menu Name</label>
                                                <input type="text" class="form-control"  value="<?php echo $menu['menu_name'] ?>" placeholder="Menu Name" name="menu_name">
                                                <?php
