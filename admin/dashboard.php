    	...
    	?>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-right">
                                    ...
                                    <div>Барлык клиенттер</div>
                                </div>
                            </div>
                        </div>
                        <a href="clients.php">
                            <div class="panel-footer">
                                <span class="pull-left">Толык Көру</span>
            ...
            <div class="card" style = "margin: 20px 10px">
                ...
                <div class="card-header tab" style="padding:0px;">
                    <button class="tablinks_orders active" onclick="openTab(event, 'recent_orders','tabcontent_orders','tablinks_orders')">Соңғы тапсырыстар</button>
                    <button class="tablinks_orders" onclick="openTab(event, 'completed_orders','tabcontent_orders','tablinks_orders')">Аяқталған тапсырыстар</button>
                    <button class="tablinks_orders" onclick="openTab(event, 'canceled_orders','tabcontent_orders','tablinks_orders')">Бас тартылған тапсырыстар</button>
                </div>
            ...
            <div class="card" style = "margin: 20px 10px">
                ...
                <div class="card-header tab" style="padding:0px;">
                    <button class="tablinks_reservations active" onclick="openTab(event, 'recent_reservations','tabcontent_reservations','tablinks_reservations')">Соңғы брондаулар</button>
                    <button class="tablinks_reservations" onclick="openTab(event, 'completed_reservations','tabcontent_reservations','tablinks_reservations')">Аяқталған резервтер</button>
                    <button class="tablinks_reservations" onclick="openTab(event, 'canceled_reservations','tabcontent_reservations','tablinks_reservations')">Тоқтатылған резервтер</button>
                </div>
