                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Жана фото косу</h5>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="image_name">Фото атауы</label>
                                    <input type="text" id="image_name_input" class="form-control"  placeholder="Атауы" name="image_name">
                                ...
                                <div class="form-group">
                                    <label for="gallery_image">Фото</label>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Болдырмау</button>
                                <button type="button" class="btn btn-info" id="add_image_bttn">Фото қосу</button>
                            </div>
                        </div>
                    </div>
                </div>
