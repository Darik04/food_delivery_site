                                    ...
                                    <div class="panel-X">
                                        ...
                                        <div class="save-header-X">
                                            <div style="display:flex">
                                                ...
                                                <div class="title-container">Кызметкер акпараты</div>
                                            </div>
                                            <div class="button-controls">
                                                <button type="submit" name="edit_user_sbmt" class="btn btn-primary">Сақтау</button>
                                            </div>
                                        </div>
                                        <div class="panel-body-X">
                                            ...
                                            <div class="form-group">
                                                <label for="user_name">Аты</label>
                                                <input type="text" class="form-control" value="<?php echo $user['username'] ?>" placeholder="Аты" name="user_name">
                                                <?php
                                            ...
                                            <div class="form-group">
                                                <label for="full_name">Толык аты</label>
                                                <input type="text" class="form-control" value="<?php echo $user['full_name'] ?>" placeholder="Толык аты" name="full_name">
                                                <?php
                                                    if(isset($_POST['edit_user_sbmt']))
                                                    {
